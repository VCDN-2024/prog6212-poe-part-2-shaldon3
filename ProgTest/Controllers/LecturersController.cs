...
namespace ProgTest.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LecturerId,FullName,Email,PhoneNumber")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LecturerId,FullName,Email,PhoneNumber")] Lecturer lecturer)
        {
